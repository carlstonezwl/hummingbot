...
class TriangularArbitrage(ScriptStrategyBase):
    ...
    def on_tick(self):
        ...
        self.log_with_clock(logging.INFO, f"fist pair: {self.first_pair},  second pair: {self.second_pair}, third pair: {self.third_pair}, Profit direct: {round(self.profit['direct'], 2)}%, "
